<<<<<<< HEAD:Artist Page/artist_register.php
<?php
    session_start();
    ...
    if (isset($_POST["submit"])){
        ...
        $query = "INSERT INTO `artist`(`ArtistEmail`, `ArtistPassword`, `ArtistName`, `ArtistGenre`, `AmountOfFollowers`, `Banking_Information`, `Country`, `ArtistRealNames`) VALUES ('$emailaddress', '$password', '$artistname', '$genre', 0, '$bank-$bankaccountnumber','$country', '$name $surname')";
        print $query;
        ...
        if (!$insert) {
            ...
            header("Location: home_artist.html");
        }
...
<body>
	<div class="div_content" class="form">
		<form name="artist-registration" action="#" method="post">
...
>>>>>>> 284b80342c4034fcab35ea399126879e856655f5:Artist Page/artist_register.html
</html>