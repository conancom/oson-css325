...
if (isset($_POST['submit-edit']) and isset($_SESSION['id-artist'])) {
    ...
    $bankinginformation = "$bank-$bankaccountnumber";
    $query = "UPDATE `artist` SET `ArtistEmail` = '$emailaddress', `ArtistPassword` = '$password', `ArtistName` = '$artistname', `ArtistGenre` = '$artistgenre', `Banking_Information` = '$bankinginformation', `Country` = '$country', `ArtistRealNames` = '$artistrealnames'
    WHERE `artist`.`idArtist` = $idartist";
    print $query;
        ...
        <div class="wrapper_main ">
            ...
            if (isset($_SESSION['id-artist'])) {
                ...
                if (!$result) {
                    ...
                    $query1 = "SELECT * FROM `artist` WHERE `idArtist` = '$idartist'";
                    // print($query); 
            ...
            <div class="AccountForm">
                <div id="header_details" class="form">
                    ...
                    <form name="artist-edit" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <select name="genre" style="margin-left: 1%;">
                            ...
                            <option value="rap" <?php
                                                if ($data1['ArtistGenre'] == 'rap') {
                                                    echo 'selected="selected"';
                                                }   ?>>Rap</option>
                            <option value="edm" <?php
                                                if ($data1['ArtistGenre'] == 'edm') {
                                                    echo 'selected="selected"';
                                                }   ?>>EDM</option>
                            <option value="rock" <?php
                                                    if ($data1['ArtistGenre'] == 'rock') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Rock</option>
                            <option value="randb" <?php
                                                    if ($data1['ArtistGenre'] == 'randb') {
                                                        echo 'selected="selected"';
                                                    }   ?>>R&B</option>
                            <option value="jazz" <?php
                                                    if ($data1['ArtistGenre'] == 'jazz') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Jazz</option>
                            <option value="metal" <?php
                                                    if ($data1['ArtistGenre'] == 'metal') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Metal</option>
                            <option value="soul" <?php
                                                    if ($data1['ArtistGenre'] == 'soul') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Soul</option>
                            <option value="raggae" <?php
                                                    if ($data1['ArtistGenre'] == 'raggae') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Raggae</option>
                            <option value="classical" <?php
                                                        if ($data1['ArtistGenre'] == 'classical') {
                                                            echo 'selected="selected"';
                                                        }   ?>>Classical</option>
                            <option value="soundtracks" <?php
                                                        if ($data1['ArtistGenre'] == 'soundtracks') {
                                                            echo 'selected="selected"';
                                                        }   ?>>Soundtracks</option>
                            <option value="Country" <?php
                                                    if ($data1['ArtistGenre'] == 'Country') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Country</option>
                            <option value="blues" <?php
                                                    if ($data1['ArtistGenre'] == 'blues') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Blues</option>
                            <option value="folk" <?php
                                                    if ($data1['ArtistGenre'] == 'folk') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Folk</option>
                            <option value="indie" <?php
                                                    if ($data1['ArtistGenre'] == 'indie') {
                                                        echo 'selected="selected"';
                                                    }   ?>>Indie</option>
                        </select><br>
                        ...
                        <select name="bank" style="margin-left: 2%; ">
                            ...
                            <option value="kbank" <?php
                                                    $pieces = explode("-", $data1['Banking_Information']);
                                                    if ($pieces[0] == 'kbank') {
                                                        echo 'selected="selected"';
                                                    }   ?>>KBANK</option>
                            <option value="tfb" <?php
                                                $pieces = explode("-", $data1['Banking_Information']);
                                                if ($pieces[0] == 'tfb') {
                                                    echo 'selected="selected"';
                                                }   ?>>TFB</option>
                            <option value="scb" <?php
                                                $pieces = explode("-", $data1['Banking_Information']);
                                                if ($pieces[0] == 'scb') {
                                                    echo 'selected="selected"';
                                                }   ?>>SCB</option>
                            <option value="bay" <?php
                                                $pieces = explode("-", $data1['Banking_Information']);
                                                if ($pieces[0] == 'bay') {
                                                    echo 'selected="selected"';
                                                }   ?>>BAY</option>
                            <option value="tmb" <?php
                                                $pieces = explode("-", $data1['Banking_Information']);
                                                if ($pieces[0] == 'tmb') {
                                                    echo 'selected="selected"';
                                                }   ?>>TMB</option>
                            ...
                            <option value="scib" <?php
                                                    $pieces = explode("-", $data1['Banking_Information']);
                                                    if ($pieces[0] == 'scib') {
                                                        echo 'selected="selected"';
                                                    }   ?>>SCIB</option>
                            <option value="scn" <?php
                                                $pieces = explode("-", $data1['Banking_Information']);
                                                if ($pieces[0] == 'scn') {
                                                    echo 'selected="selected"';
                                                }   ?>>SCN</option>
                            <option value="uob" <?php
                                                $pieces = explode("-", $data1['Banking_Information']);
                                                if ($pieces[0] == 'uob') {
                                                    echo 'selected="selected"';
                                                }   ?>>UOB</option>
