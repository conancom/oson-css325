            ...
            <div class="row">
                ...
                if (!$result) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo '   <div class="RecentsContainer">';
                        echo '     <h3 style="color: white; font-size: 35px; margin-left: 10px; margin-top: 10px; font-weight: bold;">';
                            ...
                            if (!$result) {
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($data = $result->fetch_array(MYSQLI_ASSOC)) {
                                        ...
                                        echo '             <a href="Listener-Album-Profile-Page.php?idAlbum=' . $data['idAlbum'] . '"> <img style="width: 220px; height: 220px;" src="albumimg/' . $data['idAlbum'] . '.jpg"></a>';
                                        echo '         </div>';
