...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2021 at 12:52 PM
...
--
ALTER TABLE `album`
  MODIFY `idAlbum` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `listener`
  MODIFY `idListener` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `listentosong`
--
ALTER TABLE `listentosong`
  MODIFY `ListenToSongId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
